  ...
  return (
    <section className="relative flex flex-col items-center justify-between ">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
          ...
          >
            <motion.div variants={slideUp}>
              <div className="flex items-center gap-3">
                ...
                >
                  <button 
                  className="px-3 text-xs md:px-8 py-3 md:py-4 bg-[#0d1224] rounded-full text-white text-center md:text-sm font-medium uppercase tracking-wider transition-all duration-200 ease-out md:font-semibold flex items-center gap-1 hover:gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-pink-500 to-violet-600 px-3 md:px-8 py-3 md:py-4 text-xs md:text-sm font-medium uppercase tracking-wider text-white transition-all duration-200 ease-out md:font-semibold"
                >
        ...
        {/* Right Section (moved down) */}
        <motion.div
          className="order-1 lg:order-2 mt-8 lg:mt-12 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37]"
          variants={slideLeft}
          initial="hidden"
          whileInView="visible"
